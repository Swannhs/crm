 ...
 */
export function fDateTime(date: any, format?: string): string | null {
  if (!date) {
    return null;
  }
...
/** output: 17 Apr 2022
 */
export function fDate(date: any, format?: string): string | null {
  if (!date) {
    return null;
  }
...
/** output: 12:00 am
 */
export function fTime(date: any, format?: string): string | null {
  if (!date) {
    return null;
  }
...
/** output: 1713250100
 */
export function fTimestamp(date: any): number | string | null {
  if (!date) {
    return null;
  }
 ...
 */
export function fToNow(date: any): string | null {
  if (!date) {
    return null;
  }
...
/** output: boolean
 */
export function fIsBetween(inputDate: any, startDate: any, endDate: any): boolean {
  ...
  if (formattedInputDate && formattedStartDate && formattedEndDate) {
    return Number(formattedInputDate) >= Number(formattedStartDate) && Number(formattedInputDate) <= Number(formattedEndDate);
  }
...
/** output: boolean
 */
export function fIsSame(startDate: any, endDate: any, units?: string): boolean | string {
