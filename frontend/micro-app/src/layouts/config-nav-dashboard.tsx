...
export const navData: NavSection[] = [
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Finance', path: paths.dashboard.financeSection('overview'), icon: ICONS.banking },
      ...
      { title: 'Workflow', path: paths.dashboard.workflow, icon: ICONS.analytics },
      ...
      { title: 'Organizations', path: paths.dashboard.organizations, icon: ICONS.job },
      { title: 'Devices', path: paths.dashboard.devices, icon: ICONS.external },
      { title: 'White Label', path: paths.dashboard.whiteLabel, icon: ICONS.setting },
      { title: 'Domain', path: paths.dashboard.domain, icon: ICONS.external },
