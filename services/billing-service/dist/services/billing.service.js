...
import { optionalString, parsePagination, parsePositiveInteger, } from '../validation.js';
export class BillingService {
    invoiceRepo;
    paymentRepo;
    constructor(invoiceRepo = new InvoiceRepository(), paymentRepo = new PaymentRepository()) {
    ...
    async createInvoice(orgId, userId, data) {
